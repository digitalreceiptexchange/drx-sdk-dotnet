...
namespace Net.Dreceiptx.Receipt.LineItem.Travel
{
    public class Flight : LineItem
    {
        ...
        public Flight(FlightType flightType, string airline, string shortItinerary, string longItinerary, int quantity,
            decimal price) : this(flightType, airline, shortItinerary, longItinerary, (double)quantity, price)
        {
        }

        public Flight(FlightType flightType, string airline, string shortItinerary, string longItinerary, double quantity,
