...
public class DigitalReceiptSerializer {
    ...
    private final DigitalReceiptMessage _dRxDigitalReceipt;
    
    public DigitalReceiptSerializer(){
        _dRxDigitalReceipt = new DigitalReceiptMessage();
    }
    
    public void setInvoice(Invoice invoice) {
        _dRxDigitalReceipt.setInvoice(invoice);
    }
    
    public void setStandardBusinessDocumentHeader(StandardBusinessDocumentHeader standardBusinessDocumentHeader) {
        _dRxDigitalReceipt.setStandardBusinessDocumentHeader(standardBusinessDocumentHeader);
    }
    
    public void setPaymentReceipts(List<PaymentReceipt> paymentReceipts) {
        _dRxDigitalReceipt.setPaymentReceipts(paymentReceipts);
    }
}