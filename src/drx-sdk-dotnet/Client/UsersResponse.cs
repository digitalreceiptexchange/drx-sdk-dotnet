...
namespace Net.Dreceiptx.Client
{
    ...
    public class UsersResponse
    {
        ...
        /// <summary>
        /// Deserializes the given JSON string to a UsersResponse instance
        /// </summary>
        /// <param name="json">The JSON to be deserialized</param>
        /// <returns></returns>
        public static UsersResponse DeserializeFromJson(string json)
        {
            return JsonSerializer.Deserialize<UsersResponse>(json);
        }
    }
}