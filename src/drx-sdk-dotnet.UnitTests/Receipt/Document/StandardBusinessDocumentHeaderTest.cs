...
namespace Net.Dreceiptx.UnitTests.Receipt.Document
{
    ...
    public class StandardBusinessDocumentHeaderTest
    {
        ...
        public void TestSeralization()
        {
            ...
            string expectedResult = @"{""receiver"":[{""identifier"":{""authority"":""GS1"",""value"":""AUS_ALPHA_EXPENSEMANAGER""},""contactInformation"":null},{""identifier"":{""authority"":""dRx"",""value"":""GUID:UATANZALPHAUSR14660443061787969""},""contactInformation"":[{""contactTypeCode"":""PD"",""personName"":""Grignell Michelle"",""communicationChannelCode"":[]},{""contactTypeCode"":""GR"",""personName"":""Clarke Emma MS"",""communicationChannelCode"":[]}]}],""sender"":[{""identifier"":{""authority"":""GS1"",""value"":""anz_concierge""},""contactInformation"":[{""contactTypeCode"":""SA"",""personName"":""Sabre Online"",""communicationChannelCode"":[]}]}],""documentIdentification"":{""standard"":""GS1"",""typeVersion"":""1.2.0"",""type"":""DIGITALRECEIPT"",""instanceIdentifier"":""UATANZALPHADR0000000014679796096749582"",""multipleType"":""true"",""creationDateAndTime"":""2016-11-02T12:00:00+11:00""}}";
